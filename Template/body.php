<body>
    ...
    <div class="container d-flex flex-column align-items-center" id="knowmore">

        <div class="card text-center justify-content-center" style="width: 35rem;">
            <i class="bi bi-newspaper card-img-top card-element-image-index text-center"></i>
            <div class="card-body">
                <h5 class="card-title">Vous avez dis WorkSpace ?</h5>
                <p class="card-text">Et oui, nous avons dit WorkSpace, un outil qui va vous permettre de travailler d'une manière plus efficace, de vous rendre plus productif, mais </p>
                aussi de vous permettre de vous partager les ressources de vos cours avec une plus grande facilité, pensé par un étudiant pour des étudiants.
            </div>
        </div>
        ...
        <div class="card-group text-center">
            <div class="card">
                <i class="bi bi-code-slash card-img-top card-element-image-index"></i>
                <hr>
                <div class="card-body">
            ...
            <div class="card">
                <i class="bi bi-currency-euro card-img-top card-element-image-index text-center"></i>
                <hr>
                <div class="card-body">
